...
For the website we developed we chose to try to follow the Web Sustainability Guidelines, in particular the ones defined in https://w3c.github.io/sustyweb/. Our website is minimal and uses only standard components, this makes it lighter to compile (through component reuse) and esasier on the user.
